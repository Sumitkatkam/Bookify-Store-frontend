          ...
          <div className="mt-8">
            <div className="flow-root">
              {cartItems.length > 0 ? (
                ...
                <p>No Books are added in your cart. Please add books!</p>
              )}
            </div>
          </div>
        </div>
          ...
          <div className="mt-6">
            {cartItems.length > 0 ? (
              ...
              <button
                type="button"
                disabled
                className="flex items-center justify-center rounded-md border border-transparent bg-gray-300 px-6 py-3 text-base font-medium text-white shadow-sm cursor-not-allowed">
                Checkout
              </button>
            )}
          </div>
